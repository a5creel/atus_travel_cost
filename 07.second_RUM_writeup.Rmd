...
For the average day of the year, people would travel an additional ~9 minutes further to get to outdoor recreation that is 1 degree warming and 3 for indoor leisure. 
...
In the summer, the people lose an avg of 8 minutes of welfare for a temperature increase for indoor leisure activities away from home and 13 min for outdoor for a 1 degree temperature increase. 
...
# Have these summer outdoor away elasticities trended through time? 
...
# Plotting the data using ggplot
 ggplot(seasons_elasts_long, aes(x = year, y = temp_elasticity, color = activity)) +
  ...
  ggtitle("Summer elasticities (resp. to temp increase)") +
  theme_bw()
