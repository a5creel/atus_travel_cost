...
```
 ...
 Currently dropping so much data for where I dont have temp. 
...
If I know that marginal utility of the numeraire, $\beta$, then I can calculate the expected consumer surplus, $E(U)/\beta$. 
...
If the travel cost of visiting a park went to 10,000 minutes, the average person would experience 16 minutes of welfare loss per choice occasion. I tried with 40K and got same result. This is mean to mirror price going to infinity, which is sometimes used to calcute the welfare loss of parks being taken away. 

This is per choice occasion. So this would be 97 hours per person per year (16*365/60).

Median weekly income in Q2 2023 is \$1,095, or \$27 per hour assuming a 40 hour work week. This would be a welfare loss of \$2628 per year.
...
This is really throwing me because some previous graphs made it look like recreation was increasing, but here I'm getting that the welfare has gone down through time. 
...
Think to think about with the time trend is that supply of local recreation locations has changed over time and so more people may be able to travel less??? I need to think about the different mechanisms that could lead to this result. 
